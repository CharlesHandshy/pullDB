    ...
    try:
        ...
        for page in page_iterator:
            ...
            for prefix_info in page['CommonPrefixes']:
                ...
                search_prefix = f"{tenant_prefix}daily_mydumper_{tenant_name}_{target_date}"
                ...
                if 'Contents' in response:
                    for obj in response['Contents']:
                        ...
                        if min_size_bytes <= size <= max_size_bytes:
                            ...
                            return key
                        elif size > 100 * 1024 * 1024: # Print anything over 100MB to show progress
                             print(f"Checked {tenant_name}: {size_gb:.2f} GB (Too {'small' if size < min_size_bytes else 'large'})")
