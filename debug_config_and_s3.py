...
def main():
    ...
    try:
        ...
        if not locations and config.s3_bucket_path:
             ...
             locations = (S3BackupLocationConfig(
                name="default",
        ...
        for loc in locations:
            print(f"Testing location: {loc.name} (Bucket: {loc.bucket}, Prefix: {loc.prefix})")
            ...
            try:
                ...
                response = s3.list_objects_v2(Bucket=loc.bucket, Prefix=loc.prefix, MaxKeys=5)
