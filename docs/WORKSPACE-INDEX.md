...
|----------|-------|--------------|
| Python Source | 194 | `pulldb/` |
| Tests | 157 | `pulldb/tests/`, `tests/` |
| Shell/Python Scripts | 98 | `scripts/` |
| SQL Schema | 23 | `schema/pulldb_service/` |
| Documentation | 139+ | `docs/` |
| Help Pages (HTML) | 13 | `pulldb/web/help/` |
...
*Generated by `scripts/generate_workspace_index.py` on 2026-01-17*

**Remember to update the README.md badge when regenerating!**
Badge date: `2026-01-17`