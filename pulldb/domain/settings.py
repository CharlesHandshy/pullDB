...
SETTING_REGISTRY: dict[str, SettingMeta] = {
    ...
    "expiring_warning_days": SettingMeta(
        ...
        default="7",
        description="Days before expiry to show yellow warning badge",
        setting_type=SettingType.INTEGER,
        category=SettingCategory.CLEANUP,
        dangerous=False,
        validators=["is_non_negative_integer"],
    ),
    "expiring_danger_days": SettingMeta(
        key="expiring_danger_days",
        env_var="PULLDB_EXPIRING_DANGER_DAYS",
        default="3",
        description="Days before expiry to show red danger badge",
        setting_type=SettingType.INTEGER,
        category=SettingCategory.CLEANUP,
        dangerous=False,
        validators=["is_non_negative_integer"],
