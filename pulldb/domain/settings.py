...
SETTING_REGISTRY: dict[str, SettingMeta] = {
    ...
    "s3_bucket_stg": SettingMeta(
        key="s3_bucket_stg",
        env_var="PULLDB_S3_BUCKET_STG",
        default="pestroutesrdsdbs",
        description="S3 bucket name for staging backups",
        setting_type=SettingType.STRING,
        category=SettingCategory.S3_BACKUP,
        dangerous=False,
    ),
    "s3_bucket_prod": SettingMeta(
        key="s3_bucket_prod",
        env_var="PULLDB_S3_BUCKET_PROD",
        default="pestroutes-rds-backup-prod-vpc-us-east-1-s3",
        description="S3 bucket name for production backups",
        setting_type=SettingType.STRING,
        category=SettingCategory.S3_BACKUP,
        dangerous=False,
    ),
    ...
    "s3_aws_profile_stg": SettingMeta(
        key="s3_aws_profile_stg",
        env_var="PULLDB_S3_AWS_PROFILE_STG",
        default="pr-staging",
        description="AWS profile for staging S3 bucket access",
        setting_type=SettingType.STRING,
        category=SettingCategory.S3_BACKUP,
        dangerous=False,
    ),
    "s3_aws_profile_prod": SettingMeta(
        key="s3_aws_profile_prod",
        env_var="PULLDB_S3_AWS_PROFILE_PROD",
        default="pr-prod",
        description="AWS profile for production S3 bucket access",
        setting_type=SettingType.STRING,
        category=SettingCategory.S3_BACKUP,
        dangerous=False,
    ),
