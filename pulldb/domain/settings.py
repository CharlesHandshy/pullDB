...
SETTING_REGISTRY: dict[str, SettingMeta] = {
    ...
    # -------------------------------------------------------------------------
    "overlord_enabled": SettingMeta(
        key="overlord_enabled",
        env_var="PULLDB_OVERLORD_ENABLED",
        default="false",
    ...
    "overlord_dbhost": SettingMeta(
        key="overlord_dbhost",
        env_var="PULLDB_OVERLORD_DBHOST",
        default=None,
    ...
    "overlord_database": SettingMeta(
        ...
        env_var="PULLDB_OVERLORD_DATABASE",
        default="overlord",
    ...
    "overlord_credential_ref": SettingMeta(
        ...
        env_var="PULLDB_OVERLORD_CREDENTIAL_REF",
        default=None,
