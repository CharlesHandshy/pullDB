# MyLoader 0.21.1-1 Command Line Options Reference

> **Source**: Output from `/opt/pulldb.service/bin/myloader-0.21.1-1 --help`
> **Captured**: 2026-01-31 (upgraded from 0.20.1-1)
> **Purpose**: Authoritative reference for myloader options used in pullDB
> **Changelog**: https://github.com/mydumper/mydumper/releases/tag/v0.21.1-1
...
## Options NOT Available in 0.21.x

These options do **NOT** exist in myloader 0.21.1-1:
...
## New Options in 0.21.1-1

| ✅ Option | Notes |
|-----------|-------|
| `--drop-table=MODE` | Enhanced: modes FAIL, NONE, DROP, TRUNCATE, DELETE (default without param: FAIL, with param: DROP) |
| `--source-control-command` | Options: TRADITIONAL, AWS - for replication configuration |
| `--num-sequences` | Amount of sequences in backup, read from metadata |
